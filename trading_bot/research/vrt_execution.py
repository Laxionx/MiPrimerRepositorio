...
def execute_frozen_vrt(
    ...
    observation = {
        ...
        "input_data_artifact_hashes": {str(input_path.name): _sha(input_path)}, "execution_command": command,
        "execution_configuration_hash": None, "implementation_commit": None, "preregistration_commit": None,
        "provenance_hash": None, "output_directory": str(run_dir), "expected_report_schemas": ["vrt_run_manifest.v1"],
